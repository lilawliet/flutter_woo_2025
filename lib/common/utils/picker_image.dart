...
class PickerImageWidget extends StatelessWidget {
  ...
  const PickerImageWidget({super.key, this.onTapTake, this.onTapAlbum});
    ...
    return <Widget>[
          ...
          ButtonWidget.primary(
            ...
            onTap: onTapTake == null
                ...
                : () async {
                    // 相机权限
                    var privilege = await ActionPicker.cameraPrivilege(
                      Get.context!,
                    );
                    if (!privilege.result) {
                      return;
          ...
          ButtonWidget.secondary(
            ...
            onTap: onTapAlbum == null
                ...
                : () async {
                    // 相册权限
                    var privilege = await ActionPicker.assetsPrivilege(
                      Get.context!,
                    );
                    if (!privilege.result) {
                      return;
